    ...
    private final class IOUringStreamUnsafe extends AbstractUringUnsafe {
        ...
        protected int scheduleWriteSingle(Object msg) {
            ...
            IOUringIoOps ops = IOUringIoOps.newWrite(fd().intValue(), 0, 0,
                    buf.memoryAddress() + buf.readerIndex(), buf.readableBytes(), (short) 0);
            registration().submit(ops);
            return 1;
        }
        ...
        protected int scheduleRead0() {
            ...
            IOUringIoOps ops = IOUringIoOps.newRecv(fd().intValue(), 0, 0,
                    byteBuf.memoryAddress() + byteBuf.writerIndex(), byteBuf.writableBytes(), (short) 0);
            registration().submit(ops);
            return 1;
        }
